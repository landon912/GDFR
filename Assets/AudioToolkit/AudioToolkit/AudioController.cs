...
public class AudioController : SingletonMonoBehaviour<AudioController>
{
    ...
    {
        AudioItem audioItem = subItem.GetItem();
    ...
    {
        AudioItem subItemItem = subItem.GetItem();

        if (subItemItem != null && subItemItem.category != null )
        {
            return subItemItem.category.audioController;
        }
        return this;
    }
